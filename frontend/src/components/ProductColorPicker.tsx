    ...
    <div>
      ...
      <div className="grid grid-cols-5 p-1">
        <img
          ...
          className={`h-24 m-1  border-2 border-gray-300 ${"Black" === selectedColor ? "border-3 border-black" : ""}`}
        />
        <img
          ...
          className={`h-24 m-1  border-2 border-gray-300 ${"Grey" === selectedColor ? "border-3 border-black" : ""}`}
        />
        <img
          ...
          className={`h-24 m-1  border-2 border-gray-300 ${"Yellow" === selectedColor ? "border-3 border-black" : ""}`}
        />
        <img
          ...
          className={`h-24 m-1  border-2 border-gray-300 ${"Green" === selectedColor ? "border-3 border-black" : ""}`}
        />
        <img
          ...
          className={`h-24 m-1  border-2 border-gray-300 ${"Blue" === selectedColor ? "border-3 border-black" : ""}`}
        />
        <img
          ...
          className={`h-24 m-1  border-2 border-gray-300 ${"Orange" === selectedColor ? "border-3 border-black" : ""}`}
        />
      </div>
    </div>
  );
